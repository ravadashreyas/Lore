...
- The `io.datahub.agentMemory.learnings` structured property registered once via `setup/register_properties.py` (this repo).
- Full protocol definition: `../../protocol/SPEC.md`.
