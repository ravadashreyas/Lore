...
properties are flat, entity-scoped key-to-value-list pairs; there is no native
...
(e.g. `medium` to `high`) or refreshing its evidence, the agent MAY update that existing
